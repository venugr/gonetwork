...
func main() {
	...
	// okk, noeq, kin1, kin2 := CompareMaps(trig1_status, trig2_status)
	// printMap("Keys Matching(STATUS)", okk)
	...
	// okk, noeq, kin1, kin2 = CompareMaps(trig1_owner, trig2_owner)
	...
	okk, _, kin1, kin2 := CompareFiles(trig1_files, trig2_files)
	printMap("Keys Matching(FILES)", okk)
	printMap("Keys ONLY in Map1(FILES)", kin1)
	printMap("Keys ONLY in Map2(FILES)", kin2)

}

func CompareFiles(map1, map2 map[string]string) (map[string]string, map[string]string, map[string]string, map[string]string) {
